...
Project Structure
plaintextCopy/home/sanskar/mysite/
├── index.html
├── styles.css
└── images/
└── logo.png
...
nginxCopy# Method 1: Include predefined types
http {
include mime.types;
}
...
nginxCopy# Serving static files
location /static/ {
root /home/sanskar/mysite;
...
nginxCopy# Define upstream servers
...
nginxCopyupstream backendserver { # Least connections
least_conn;
...
log*file="loadbalancer_test*$(date +%Y%m%d_%H%M%S).log"
...
nginxCopy# Increase proxy timeouts
location / {
